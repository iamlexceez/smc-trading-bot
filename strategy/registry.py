...
STRATEGIES: tuple[StrategyDefinition, ...] = (
    ...
    StrategyDefinition("liquidity_sweep_continuation", "Liquidity sweep continuation with aligned structure and displacement.", ("TRENDING", "EXPANSION"), ("COMPRESSION",), ("M5", "M15", "M30", "H1"), ("liquidity_sweep", "displacement", "htf_alignment")),
    StrategyDefinition("bos_choch_continuation", "BOS or CHOCH continuation using existing structural events.", ("TRENDING", "TRANSITION"), ("COMPRESSION",), ("M5", "M15", "M30", "H1"), ("structure_event", "htf_alignment")),
    StrategyDefinition("displacement_continuation", "Continuation after an observed displacement event.", ("EXPANSION", "TRENDING"), ("RANGING", "COMPRESSION"), ("M1", "M5", "M15"), ("displacement", "htf_alignment")),
    ...
    StrategyDefinition("fvg_continuation", "Fair-value-gap continuation with aligned structure.", ("TRENDING", "EXPANSION"), ("RANGING",), ("M1", "M5", "M15"), ("fvg", "htf_alignment")),
    StrategyDefinition("breakout_retest", "Breakout and retest continuation based on existing structure and zone observations.", ("COMPRESSION", "TRANSITION", "EXPANSION"), ("EXHAUSTION",), ("M5", "M15", "M30"), ("structure_event", "htf_alignment")),
    ...
    StrategyDefinition("layered_continuation", "Continuation layer only after original-thesis confirmation and independent broker checks.", ("TRENDING", "EXPANSION"), ("RANGING", "EXHAUSTION"), ("M5", "M15", "M30"), ("structure_event", "displacement", "htf_alignment")),
)
