...
def main_menu() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("📦 Baskets", callback_data="baskets"),
...
def settings_menu() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🎚 Entry Mode", callback_data="set_entry_mode"),
         InlineKeyboardButton("📦 Layers", callback_data="baskets")],
        [InlineKeyboardButton("🛡 Safety Limits", callback_data="safety"),
         InlineKeyboardButton("📈 Daily Profit Stop", callback_data="set_daily_limit")],
        ...
        [InlineKeyboardButton("🌊 AI Sentiment", callback_data="toggle_sentiment"),
         InlineKeyboardButton("🧠 Self-Opt", callback_data="toggle_optimization")],
        [InlineKeyboardButton("🏦 Multi-Broker", callback_data="multi_broker_menu"),
