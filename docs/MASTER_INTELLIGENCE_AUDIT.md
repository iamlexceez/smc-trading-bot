...
| Testing | `tests/*.py`, `tests/smoke_upgrade.py` | 45 tests pass plus smoke; broker-mock, walk-forward, and full cross-subsystem coverage remain incomplete |
