...
| Risk and sizing | `risk/manager.py`, `strategy/setup_validator.py`, `executors/mt5.py`, `analysis/capital_state.py` | Present; broker economics remain authoritative, and broker quote freshness now fails closed through configurable account-state validation |
